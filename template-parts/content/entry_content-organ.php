...
<div class="<?php echo esc_attr( apply_filters( 'kadence_entry_content_class', 'entry-content single-content' ) ); ?>">
	...
	if ( queenbee() ) {
		$settings = array( 'fields' => array( 'builder', 'model', 'opus_num', 'build_year', 'venue_filename', 'num_manuals', 'num_divisions', 'num_ranks', 'num_stops', 'num_pipes', 'num_registers', 'action_type', 'organ_sum_html', 'organ_html', 'divisions_html', 'stops_summary' ) );
		acf_form( $settings );	
	}
